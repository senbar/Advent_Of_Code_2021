...
namespace Day_4_Giant_Squid_Part_2
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Advent of code - DAY 4 - Giant Squid - Part 2");
            ...
            int numOfAlreadyWinningTables = 0;
            int wonIndex = -1;
            string calledNum = "";
            ...
            for (int i = 0; i < bingoNumsTable.Count; i++)
            {
                ...
                foreach (List<List<string>> tableList in listOfBingoTables)
                {
                    for (int x = 0; x < 5; x++)
                    {
                        ...
                        {
                            numOfAlreadyWinningTables += 1;
                            wonIndex = n;
                            calledNum = checkingNum;

                            if (numOfAlreadyWinningTables < 100)
                            {
                                for (int q = 0; q < 5; q++)
                                {
                                    for (int s = 0; s < 5; s++)
                        ...
                        {
                            numOfAlreadyWinningTables = numOfAlreadyWinningTables + 1;
                            wonIndex = n;
                            calledNum = checkingNum;
